...
import com.gaming.know_your_ability.Profile.AccountSettingsActivity;
...
public class FirebaseMethods {
        ...
        if(photoType.equals(mContext.getString(R.string.new_photo))){
            ...
            .addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
                ...
                public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                  // String image = taskSnapshot.getMetadata().getReference().getDownloadUrl().toString();
                    // show image
     ...
     * @param phoneNumber
     */
    public void updateUserAccountSettings(String displayName, String description,String dob, String phoneNumber,String schl,String clas){
       ...
       /* if(website != null) {
        ...
        if(schl != null) {
            myRef.child(mContext.getString(R.string.dbname_user_account_settings))
                    .child(userID)
                    .child(mContext.getString(R.string.field_school))
                    .setValue(schl);
        }
        ...
        if(clas != null) {
            myRef.child(mContext.getString(R.string.dbname_user_account_settings))
                    .child(userID)
                    .child(mContext.getString(R.string.field_classes))
                    .setValue(clas);
        }
    }
...
//    }
    ...
    public void addNewUser(String email, String username, String description, String profile_photo){
        ...
        User user = new User( userID, "7986865212",  email,  StringManipulation.condenseUsername(username),"01/03/1998","C.C girls high school","12");
